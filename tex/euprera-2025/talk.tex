  ...
  \begin{columns}[t]
    \begin{column}[t]{0.5\textwidth}
      \begin{itemize}
        ...
        \item Manual coding vs. scale/nuance
  ...
  \begin{columns}[t]
    \begin{column}[t]{0.5\textwidth}
      \begin{itemize}
        ...
        \item \textbf{Expectations of lexical analysis}
      \end{itemize}
    \end{column}
    \begin{column}[t]{0.5\textwidth}
      \vspace*{0pt}
      \includegraphics[
        ...
        trim=0 0 0 0,
        clip
      ]{../../fig/table_s_tight.png}
      Graphic: stakeholder mapping
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \vspace*{0pt}
      %\includegraphics[width=\linewidth]{../../fig/table_framing_type_term.png}
      \includegraphics[
        width=\linewidth,
        ...
        trim=0 80 0 0,
        clip
      ]{../../fig/table_framing_type_term.png}
      Diagram: framing strategies
    \end{column}
  \end{columns}
\end{frame}
\fi
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \vspace*{0pt}
      \includegraphics[width=\linewidth]{../../fig/unit_circle_vectors_arcs.png}
...
\begin{frame}
  \frametitle{Lexical Analysis Results (1)}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
    ...
    \begin{column}{0.5\textwidth}
      ...
      \includegraphics[
        ...
        trim=0 0 0 0,
        clip
      ]{../../fig/heatmap_stakeholder.png}
      Example stakeholder word counts
    \end{column}
  \end{columns}
\end{frame}

\begin{frame}
  \frametitle{Lexical Analysis Results (2)}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item Shell: "innovation", "technology"
        \item WWF: "duty", "crisis", "action"
        \item Terms contrast between orgs
        \item \textbf{Shell = economic/regulatory \& opportunity}
        \item \textbf{WWF = community/environment \& moral}
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \vspace*{0pt}
      \includegraphics[
        ...
        trim=0 0 0 0,
        clip
      ]{../../fig/heatmap_framing.png}
      Example framing word counts
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item Theoretical terms vs. empirical sentences
        \item Shell sentences align mostly with economic stakeholders and opportunity framing
        \item WWF sentences align mostly with community stakeholders and moral framing
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \item NLP helps apply and refine both theories
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        \item Overall content similarity to theories
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \vspace*{0pt}
      \includegraphics[width=\linewidth]{../../fig/unit_circle_vectors_arcs.png}
      Cloud or NLP infrastructure diagram
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      ...
      Multimodal analysis, multiple communication areas
    \end{column}
  \end{columns}
\end{frame}
